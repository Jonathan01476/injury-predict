...
).add_local_file(ROOT/'serve.py','/root/serve.py').add_local_file(ROOT/'pipeline_def.py','/root/pipeline_def.py').add_local_file(ROOT/'pipeline.joblib','/root/pipeline.joblib')
